...
>
    ...
    <div class="mt-3 flex gap-3">
        <p x-ref="aiSum" class="whitespace-pre-line text-sm leading-6 text-slate-700">
            IEP coverage is highly uneven across regions, ranging from 25% in Regions 02, 05, 12, and 15 to 100% in Region 08, with Region 11 (80%), Region 07 (50%), Region 16 (40%), Region 01 (33.3%), and Region 03 (30%) in between. Several regions (e.g., Regions 04, 10, and 14) show near-zero or missing values, likely incomplete reporting. The pattern suggests stronger IEP uptake in some regions and weaker coverage in others. <br> <br> Suggested next steps: validate denominators and reporting completeness, confirm a consistent IEP definition in data entry, then target support to persistently low-coverage regions.
        </p>
    </div>
